    ...
    <SafeAreaView style={styles.titleContainer}>
        ...
        <View style={styles.content}>
            ...
            <View style={{backgroundColor:"#e3e3e3", height:160, borderRadius:15, width:300, alignSelf:'center'}}>
                ...
                <TouchableOpacity style={{height:40, width:80, backgroundColor:'white', alignSelf:'center', alignItems:'center', marginTop: height * 0.03}} onPress={handleSubmit(handlePasswordReset)}><text style={{marginTop:11}}><b>Enviar</b></text></TouchableOpacity>
